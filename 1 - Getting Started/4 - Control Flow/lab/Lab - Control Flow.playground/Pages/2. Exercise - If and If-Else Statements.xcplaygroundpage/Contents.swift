...
dollars = 105
if dollars == 0 {
    print("Sorry kid. You're really broke!")
}
else if dollars <= 100  {
    print("You've got some spending money now!")
} else if dollars > 100 {
    print("Looks to me like you're rich!") // else if used when chaning values
} else {
// else used when there are no changes
}
