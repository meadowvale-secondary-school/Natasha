...
let isInTarget = currentHR > targetLowerBound && currentHR < targetUpperBound // target is greater than 120 and less than 150
let isBelowTarget = currentHR < targetLowerBound
let isAboveTarget = currentHR >= targetUpperBound

if isInTarget {
    print("You are in the target! Good Job!")
}
else if isBelowTarget {
    print("Keep going! You'll get there!")
}
else if isAboveTarget {
    print("You are going above and beyond, well done!")
}
