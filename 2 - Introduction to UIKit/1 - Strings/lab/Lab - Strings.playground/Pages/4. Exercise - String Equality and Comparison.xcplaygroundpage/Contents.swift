...
if name.lowercased() == nameInCaps.lowercased() {
    print("\(name) and \(nameInCaps.lowercased()) are equal")
} else {
 ...
 */
let junior:String = "Cal Ripken Jr."
 ...
 */
import Foundation
let textToSearchThrough = "To be, or not to be--that is the question".lowercased()
let textToSearchFor = "to be, or not to be"

if textToSearchThrough.contains(textToSearchFor) {
    print("I found it!")
} else {
    print("Sorry, it's not here!")
}
