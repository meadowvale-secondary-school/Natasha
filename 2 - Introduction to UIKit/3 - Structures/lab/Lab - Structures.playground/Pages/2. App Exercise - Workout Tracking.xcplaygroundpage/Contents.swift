 ...
 */
var firstRunOutcome = RunningWorkout(distance: 2396.0, time: 15.3, elevation: 94)

print("Good work! You ran \(firstRunOutcome.distance) m in \(firstRunOutcome.time) minutes, at an elevation of \(firstRunOutcome.elevation)m!")
