 ...
 */
let somePlace = GPS(latitude: 51.514004, longitude: 0.125226) //memberwise intializer
...
var favoriteBook = Book(author: "Alia Schlok", title: "Tomorrow There Will Be Apricots", pages: 300, price: 12.0)
print("My favorite book is called \(favoriteBook.title) and is written by \(favoriteBook.author) and is \(favoriteBook.pages) pages and costs \(favoriteBook.price)")
...
//custom initalizer
struct Height {
    var heightInInches = Double() //properties
    var heightInCentimeters = Double()
    
init(centimeterHeight: Double) {
     heightInInches = centimeterHeight / 2.54
    }
    init (inchHeight: Double) {
    heightInCentimeters = inchHeight * 2.54
    }
}
 ...
 */
var someonesHeight = Height(centimeterHeight: 165.1)
 ...
 */
var myHeight = Height(inchHeight: 61)
print(myHeight.heightInCentimeters)

var myHeightIn = Height(centimeterHeight: 154.94) //instances 
print(myHeightIn.heightInInches)  //equal to each other
