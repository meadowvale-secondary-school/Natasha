 ...
 */
var userInfo = User(name: "Natasha", age: 16, height: 155.1, weight: 120.5, activityLevel: 7) //memberwise intializer 
...
struct Distance {
    ...
    init(metersDistance: Double) {
        feet = metersDistance * 3.28084
    }
    
    init(feetDistance: Double){
        meters = feetDistance / 3.28084
    }
}
 ...
 */
var mile = Distance(metersDistance: 1600)
print(mile.feet)

/*:
 Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
 */
var metersLength = Distance(feetDistance: 10)
print(metersLength.meters)
