...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = "Natasha" //constant value for all User Instances
    
}

//let userLogIn = User.logIn(user:User) ?

var userInfo = User(userName: "natatat", email: "natcho@gmail.com", age: 21)

let currentUser = User.currentUser //You can access type properties using dot syntax on the type name
