 ...
 */
var walkingChallenge: [String] = ["5 thousand steps!", "Walk to school!"]
var runningChallenge: [String] = ["Run 5 times a week!", "Run around the block!"]
 ...
 */
var challenges = [walkingChallenge, runningChallenge] //array within an array, combining them
//is...["5 thousand steps!", "Walk to school!","Run 5 times a week!", "Run around the block!"]

let walkingChallenges = challenges[0] //using subscript, can access a collection (second collection - runningChallenge
//["5 thousand steps!", "Walk to school!"] - walkingChallenge collection

let runningChallenge1 = challenges[1][1] //using TWO subcripts, can access collection, and element by number
//"Run around the block!" - runningChallenge collection, second element
 ...
 */
var committedChallenges: [String] = ["Zumba"]

/*:
 Write an if statement that will use `isEmpty` to check if there is anything in the array. If there is not, print a statement asking the user to commit to a challenge. Add an else-if statement that will print "The challenge you have chosen is <INSERT CHOSEN CHALLENGE>" if the array count is exactly 1. Then add an else statement that will print "You have chosen multiple challenges."
 */
if committedChallenges.isEmpty { //check to see if array is empty
    print("Please choose a challenge to try out.")
    
} else if committedChallenges.count == 1 { //conditon of array having one element = TRUE
    print("The challenge you have chosen is \(committedChallenges[0])") //accessing element to print using subscript [0]
    
} else {
    print("You have chosen multiple challenges")
}

//prints: The challenge you have chosen is Zumba
