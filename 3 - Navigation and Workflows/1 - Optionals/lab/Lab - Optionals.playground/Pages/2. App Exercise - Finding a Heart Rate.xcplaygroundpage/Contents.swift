 ...
 */
var heartRate: Int? = nil //set to nil, but can have value later
print(heartRate) //set to nil, prints nothing
...
if let optionHeartRate = heartRate {
    let hrAverage: Int = (optionHeartRate + oldHR1 + oldHR2 + oldHR3 + oldHR4)/5
