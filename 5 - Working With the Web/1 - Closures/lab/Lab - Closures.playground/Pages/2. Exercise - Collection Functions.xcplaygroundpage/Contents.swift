 ...
 */
let names: [String] = ["Junita", "Aaron", "Maryann", "KC", "Ashvini"]

let sortedCollection1 = names.sorted(by: forwards)
print(sortedCollection1)

//prints: ["Aaron", "Ashvini", "Junita", "KC", "Maryann"]
/*:
 ...
 */
//Much simpler way to sorting collection using closure by alphabet!!
